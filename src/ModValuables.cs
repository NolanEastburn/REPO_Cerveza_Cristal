...
public static class ModValuables
{
    public static readonly ModValuableRegistry.ValuableAddition TEST_VALUABLE =
     new ModValuableRegistry.ValuableAddition(assetName: "Cone", valuableData: new ModValuableRegistry.Data(name: "Test Valuable"));
    ...
    (name: "Cerveza Cristal Bottle", value: (1000, 3000), mass: 0.25f, ValuableVolume.Type.Small, durability: 5.0f, fragility: 80.0f));
